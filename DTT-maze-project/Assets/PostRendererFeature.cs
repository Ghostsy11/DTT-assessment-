...
public sealed class PostRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        PostVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<PostVolumeComponent>();
